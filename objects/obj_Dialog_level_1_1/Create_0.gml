...
dialog.add(PlayerFace, "Удалось!");
dialog.add(faceTest, "...");
dialog.add(PlayerFace, "Вставай скорей, остальные наверняка уже работают!");
dialog.add(faceTest, ".....");
...
dialog.add(PlayerFace, "('Е' для взаимодействия, 'R' для броска)");
